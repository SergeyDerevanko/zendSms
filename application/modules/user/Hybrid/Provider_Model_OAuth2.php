...
/**
 * To implement an OAuth 2 based service provider, User_Hybrid_Provider_Model_OAuth2
 * can be used to save the hassle of the authentication flow. 
 * 
 * Each class that inherit from User_Hybrid_Provider_Model_OAuth2 have to implemenent
 * at least 2 methods:
 ...
 *
 * User_Hybrid_Provider_Model_OAuth2 use OAuth2Client v0.1 which can be found on
 * Hybrid/thirdparty/OAuth/OAuth2Client.php
 */
class User_Hybrid_Provider_Model_OAuth2 extends User_Hybrid_Provider_Model
{
	// default permissions 
	public $scope = "";
	...
	*/
	function initialize() 
	{
		...
		require_once User_Hybrid_Auth::$config["path_libraries"] . "OAuth/OAuth2Client.php";
	...
	*/
	function loginBegin()
	{
		...
		User_Hybrid_Auth::redirect( $this->api->authorizeUrl( array( "scope" => $this->scope ) ) );
	}
