...
class OAuth2Client
{
	...
	*/
	...
	{
		User_Hybrid_Logger::info( "Enter OAuth2Client::request( $url )" );
		User_Hybrid_Logger::debug( "OAuth2Client::request(). dump request params: ", serialize( $params ) );
		...
		User_Hybrid_Logger::debug( "OAuth2Client::request(). dump request info: ", serialize( curl_getinfo($ch) ) );
		User_Hybrid_Logger::debug( "OAuth2Client::request(). dump request result: ", serialize( $response ) );
