...
class OAuth1Client{
	...
	*/ 
	...
	{
		User_Hybrid_Logger::info( "Enter OAuth1Client::request( $method, $url )" );
		User_Hybrid_Logger::debug( "OAuth1Client::request(). dump post fields: ", serialize( $postfields ) );
		...
		User_Hybrid_Logger::debug( "OAuth1Client::request(). dump request info: ", serialize( curl_getinfo($ci) ) );
		User_Hybrid_Logger::debug( "OAuth1Client::request(). dump request result: ", serialize( $response ) );
