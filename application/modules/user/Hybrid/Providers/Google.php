...
/**
 * User_Hybrid_Providers_Google provider adapter based on OAuth2 protocol
 * 
 * http://hybridauth.sourceforge.net/userguide/IDProvider_info_Google.html
 */
class User_Hybrid_Providers_Google extends User_Hybrid_Provider_Model_OAuth2
{
	// default permissions 
	...
	*/
	function loginBegin()
	{
		...
		User_Hybrid_Auth::redirect( $this->api->authorizeUrl( $parameters ) );
	}
