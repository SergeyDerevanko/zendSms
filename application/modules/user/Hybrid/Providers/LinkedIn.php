...
/**
 * User_Hybrid_Providers_LinkedIn provider adapter based on OAuth1 protocol
 * 
 * User_Hybrid_Providers_LinkedIn use linkedinPHP library created by fiftyMission Inc.
 * 
 * http://hybridauth.sourceforge.net/userguide/IDProvider_info_LinkedIn.html
 */
class User_Hybrid_Providers_LinkedIn extends User_Hybrid_Provider_Model
{ 
	/**
	...
	*/
	function initialize()
	{
		...
		require_once User_Hybrid_Auth::$config["path_libraries"] . "LinkedIn/LinkedIn.php";
	...
	*/
	function loginBegin()
	{
		...
		if( isset( $response['success'] ) && $response['success'] === TRUE ){
			...
			User_Hybrid_Auth::redirect( LINKEDIN::_URL_AUTH . $response['linkedin']['oauth_token'] );
		}
		else{
