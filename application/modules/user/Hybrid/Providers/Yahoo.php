...
/**
 * User_Hybrid_Providers_Yahoo - Yahoo provider adapter based on OAuth1 protocol
 */
class User_Hybrid_Providers_Yahoo extends User_Hybrid_Provider_Model_OAuth1
{
	function initialize() 
	{
		parent::initialize();
