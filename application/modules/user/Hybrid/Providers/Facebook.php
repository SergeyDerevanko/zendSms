...
/**
 * User_Hybrid_Providers_Facebook provider adapter based on OAuth2 protocol
 * 
 * User_Hybrid_Providers_Facebook use the Facebook PHP SDK created by Facebook
 * 
 * http://hybridauth.sourceforge.net/userguide/IDProvider_info_Facebook.html
 */
class User_Hybrid_Providers_Facebook extends User_Hybrid_Provider_Model
{
	...
	*/
	function initialize() 
	{
		...
		if ( ! class_exists('FacebookApiException', false) ) {
			require_once User_Hybrid_Auth::$config["path_libraries"] . "Facebook/base_facebook.php";
			require_once User_Hybrid_Auth::$config["path_libraries"] . "Facebook/facebook.php";
		}
		
		if ( isset ( User_Hybrid_Auth::$config["proxy"] ) ) {
			BaseFacebook::$CURL_OPTS[CURLOPT_PROXY] = User_Hybrid_Auth::$config["proxy"];
		}
	...
	*/
	function getUserContacts()
	{
		...
		foreach( $response["data"] as $item ){
			$uc = new User_Hybrid_User_Contact();
	...
	*/
	function getUserActivity( $stream )
	{
		...
		foreach( $response['data'] as $item ){
			...
			$ua = new User_Hybrid_User_Activity();
