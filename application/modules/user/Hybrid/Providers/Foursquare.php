...
/**
 * User_Hybrid_Providers_Foursquare provider adapter based on OAuth2 protocol
 * 
 * http://hybridauth.sourceforge.net/userguide/IDProvider_info_Foursquare.html
 */
class User_Hybrid_Providers_Foursquare extends User_Hybrid_Provider_Model_OAuth2
{ 
	/**
