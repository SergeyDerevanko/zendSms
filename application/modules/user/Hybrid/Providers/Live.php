...
/**
 * User_Hybrid_Providers_Live - Windows Live provider adapter based on OAuth2 protocol
 */
class User_Hybrid_Providers_Live extends User_Hybrid_Provider_Model_OAuth2
{
	// default permissions 
