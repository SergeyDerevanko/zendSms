...
class lessc_parser {
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            self::$operatorString =
                '('.implode('|', array_map(array('Ikantam_Lib_Lessc', 'preg_quote'),
                    array_keys(self::$precedence))).')';

            $commentSingle = Ikantam_Lib_Lessc::preg_quote(self::$commentSingle);
            $commentMultiLeft = Ikantam_Lib_Lessc::preg_quote(self::$commentMultiLeft);
            $commentMultiRight = Ikantam_Lib_Lessc::preg_quote(self::$commentMultiRight);
    ...
    protected function isDirective($dirname, $directives) {
        ...
        $pattern = implode("|",
            array_map(array("Ikantam_Lib_Lessc", "preg_quote"), $directives));
    ...
    protected function expressionList(&$exps) {
        ...
        $exps = Ikantam_Lib_Lessc::compressList($values, ' ');
        return true;
    }
    ...
    public function propertyValue(&$value, $keyName = null) {
        ...
        $value = Ikantam_Lib_Lessc::compressList($values, ', ');
        return true;
    }
    ...
    protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
        ...
        $stop = array("'", '"', "@{", $end);
        $stop = array_map(array("ikantam_Lib_Lessc", "preg_quote"), $stop);
    ...
    protected function string(&$out) {
        ...
        $patt = '([^\n]*?)(@\{|\\\\|' .
            Ikantam_Lib_Lessc::preg_quote($delim).')';
    ...
    protected function literal($what, $eatWhitespace = null) {
        ...
        if (!isset(self::$literalCache[$what])) {
            self::$literalCache[$what] = Ikantam_Lib_Lessc::preg_quote($what);
        }
    ...
    protected function to($what, &$out, $until = false, $allowNewline = false) {
        ...
        if (!$this->match('('.$validChars.'*?)'.Ikantam_Lib_Lessc::preg_quote($what), $m, !$until)) return false;
