 ...
 * @package    Zend_Math
 */
abstract class Ikantam_Lib_Math_Rand
{
    const ALPHA_NUMERIC = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
    const ALPHA_NUMERIC_LOWERCASE = 'abcdefghijklmnopqrstuvwxyz0123456789';
    const ALPHA_NUMERIC_UPPERCASE = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
    ...
    public static function get62String($length)
    {
    	return static::getString($length, $charlist = self::ALPHA_NUMERIC);
    }
}
